...
This repository contains beginner-friendly Java programs created as part of my Java Developer learning journey.
...
* Variables
* Primitive data types (`int`, `double`, `float`, `char`, `boolean`, `long`, `short`, `byte`)
* `String`
